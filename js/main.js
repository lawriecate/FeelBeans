...
function welcomeGuide(){
  ...
  function showStage() {
    ...
    if(stage==5) {
      var name = $("#name").val();
      var dailyGoal = $("#dailyGoal").val();
      var weekendGoal = $("#weekendGoal").val();
      setUserAccount(name,dailyGoal,weekendGoal);
      setTimeout(function() {
...
//console.log(getAccountPurchases());
$(".uname").text(account.username);
$(".dgoal").text(account.weekdayGoal);
$(".wgoal").text(account.weekendGoal);
